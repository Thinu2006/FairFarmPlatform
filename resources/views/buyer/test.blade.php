...
@section('content')
    ...
    <section class="relative w-full min-h-[50vh] md:min-h-[90vh] overflow-hidden">
        ...
        <div class="slideshow-container w-full h-full relative">
            ...
            <div class="slide fade w-full h-full bg-cover bg-center flex items-center justify-center" style="background-image: url('{{ asset('images/farmers-market.jpg') }}'); opacity: 1;">
            ...
            <div class="slide fade w-full h-full bg-cover bg-center flex items-center justify-center" style="background-image: url('{{ asset('images/premium-rice.png') }}');">
                <div class="absolute inset-0 bg-gradient-to-r from-black/60 to-black/40 flex items-center justify-center px-4 sm:px-8 md:px-12 text-center">
            ...
            <div class="slide fade w-full h-full bg-cover bg-center flex items-center justify-center" style="background-image: url('{{ asset('images/happy-farmer.jpg') }}');">
                <div class="absolute inset-0 bg-gradient-to-r from-black/60 to-black/40 flex items-center justify-center px-4 sm:px-8 md:px-12 text-center">
            ...
            <div class="slide fade w-full h-full bg-cover bg-center flex items-center justify-center" style="background-image: url('{{ asset('images/rice-varieties.png') }}');">
                <div class="absolute inset-0 bg-gradient-to-r from-black/60 to-black/40 flex items-center justify-center px-4 sm:px-8 md:px-12 text-center">
        ...
        <!-- Slideshow Controls - Responsive Sizing -->
        ...
        <!-- Slideshow Dots - Responsive Positioning -->
