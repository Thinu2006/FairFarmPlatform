                    ...
                    @foreach ($sellingPaddyTypes as $paddy)
                        <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
                            ...
                            <div class="mt-4">
                                ...
                                <p class="text-gray-800 font-bold mt-2 text-base">Rs {{ number_format($paddy->PriceSelected, 2) }} per bu</p>
                                <p class="text-gray-800 font-bold mt-2 text-base">Available Quantity: {{ $paddy->Quantity }} bu</p>
