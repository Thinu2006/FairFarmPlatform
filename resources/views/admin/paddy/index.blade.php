                ...
                <div class="p-4 mb-4">
                    ...
                    <div class="mt-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-sm font-bold text-gray-800">Rs. {{ number_format($paddy->MinPricePerKg, 2) }}/bu</span>
                        </div>
                        <div class="flex justify-between items-center mt-1">
                            <span class="text-sm font-medium text-gray-500">Max Price:</span>
                            <span class="text-sm font-bold text-gray-800">Rs. {{ number_format($paddy->MaxPricePerKg, 2) }}/bu</span>
                        </div>
                    </div>
                </div>
            </div>
