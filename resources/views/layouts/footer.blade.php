<footer class="bg-[#123D1E] text-white py-6 px-6">
    <div class="container mx-auto flex flex-col items-center text-center">

        <!-- Description -->
        <p class="text-gray-300 max-w-lg mx-auto leading-relaxed mb-4">
        ...
        <!-- Bottom Border Line -->
        <div class="border-t border-gray-500 w-full max-w-2xl my-6"></div>
