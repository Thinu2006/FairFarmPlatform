...
<body class="bg-cover bg-center min-h-screen flex justify-center items-center px-4" 
    ...
    <div class="bg-white shadow-lg rounded-lg flex w-full max-w-4xl overflow-hidden">
        <!-- Left Section -->
        <div class="w-1/2 p-10 flex flex-col justify-center items-center text-white text-center bg-gradient-to-r from-green-800 to-green-600">
        ...
        <div class="w-1/2 p-10">
            ...
            <form method="POST" action="{{ route('farmer.login') }}" class="form-container">
                @csrf
                <div>
