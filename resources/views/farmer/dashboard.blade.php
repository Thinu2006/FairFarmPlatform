                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl md:text-2xl font-bold text-gray-800 mt-1">{{ $stats['total_orders'] }}</p>
                            <p class="text-sm text-gray-500 mt-1">{{ $stats['pending_orders'] }} pending</p>
                        </div>
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl md:text-2xl font-bold text-gray-800 mt-1">Rs {{ number_format($stats['total_revenue'], 2) }}</p>
                            <p class="text-sm text-gray-500 mt-1">Last 30 days: Rs {{ number_format($stats['monthly_revenue'], 2) }}</p>
                        </div>
                        <div class="bg-black p-3 rounded-full w-12 h-12 flex items-center justify-center">
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl md:text-2xl font-bold text-gray-800 mt-1">{{ $stats['active_listings'] }}</p>
                            <p class="text-sm text-gray-500 mt-1">{{ $stats['low_stock_listings'] }} low stock</p>
                        </div>
                        <div class="bg-black p-3 rounded-full w-12 h-12 flex items-center justify-center">
                ...
                <div class="flex flex-col md:flex-row gap-6">
                    ...
                    <div class="w-full md:w-1/2">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            @foreach($stats['order_status_counts'] as $status => $count)
                            @php 
